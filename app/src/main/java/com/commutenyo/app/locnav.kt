...
import com.commutenyo.app.databinding.ActivityMapslocationBinding
...
class locnav : AppCompatActivity(), OnMapReadyCallback, PermissionsListener,
    OnMapClickListener {
    ...
    override fun onMapReady(mapboxMap: MapboxMap) {
        ...
        mapboxMap.setStyle(
            ...
            val drawable =
                ResourcesCompat.getDrawable(resources, R.drawable.img, null)
    ...
    private fun initSearchFab() {
        binding.fabsearch.setOnClickListener { v: View? ->
...
// Move map camera to the selected location
    ...
    private fun enableLocationComponent(loadedMapStyle: Style?) {
        ...
        if (PermissionsManager.areLocationPermissionsGranted(this@locnav)) {
