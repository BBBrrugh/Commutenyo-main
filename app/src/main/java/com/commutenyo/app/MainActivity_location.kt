...
import com.commutenyo.app.ConstantsUtils.locationDestination
import com.commutenyo.app.ConstantsUtils.locationStart
import com.commutenyo.app.LocationHandler.isGpsEnabled
import com.commutenyo.app.LocationHandler.isLocationApproved
import com.commutenyo.app.ScreenUtils.getScreenHeight
import com.commutenyo.app.ScreenUtils.getScreenWidth
import com.commutenyo.app.databinding.ActivityMainrouteBinding
import com.commutenyo.app.databinding.DialogProgressBinding
import com.google.android.gms.location.FusedLocationProviderClient
import com.google.android.gms.location.LocationServices
import kotlinx.coroutines.*
import java.util.*

class MainActivity_location : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_mainroute)
        ...
        runOnUiThread {
            ...
            CoroutineScope(Dispatchers.Main + handler).launch {
                async(Dispatchers.IO+handler) {
                    ...
                    val geocoder = Geocoder(this@MainActivity_location, Locale.getDefault())
